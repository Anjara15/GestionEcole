...
<body>
    ...
    <div class="main-content">
        ...
        <form action="<?= site_url('matieres/update/' . esc($matiere['id'])) ?>" method="post">
            <div class="form-group">
                <label for="niveau">Niveau</label>
                <input type="text" name="niveau" id="niveau" class="form-control" value="<?= esc($matiere['niveau']) ?>" required>
            </div>
            <div class="form-group">
                <label for="nom_matiere">Nom de la matière</label>
                <input type="text" name="nom_matiere" id="nom_matiere" class="form-control" value="<?= esc($matiere['nom_matiere']) ?>" required>
            </div>
            <div class="form-group">
                <label for="enseignant">Enseignant</label>
                <input type="text" name="enseignant" id="enseignant" class="form-control" value="<?= esc($matiere['enseignant']) ?>" required>
            </div>
            <div class="form-group">
                <label for="type">Type</label>
                <input type="text" name="type" id="type" class="form-control" value="<?= esc($matiere['type']) ?>" required>
            </div>
            <div class="form-group">
                <button type="submit" class="btn btn-primary">Modifier</button>
                <a href="<?= site_url('matieres') ?>" class="btn btn-danger">Annuler</a>
            </div>
        </form>
    </div>
    </div>
