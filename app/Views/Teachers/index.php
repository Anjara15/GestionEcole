    ...
    <div class="main-content">
        ...
        <div class="content-container">
            ...
            <div class="table-wrapper">
                <table class="table" id="professorTable">
                    <thead>
                        <tr>
                            <th>Nom</th>
                            <th>Contact</th>
                        ...
                        <?php if (!empty($teachers) && is_array($teachers)): ?>
                            <?php foreach ($teachers as $teacher): ?>
                                <tr>
                                    ...
                                    <td><?= esc($teacher['contact']) ?></td>
                                    <td><?= esc($teacher['email']) ?></td>
                                    <td><?= esc($teacher['intervenant']) ?></td>
                                    <td>
                                        <a href="<?= site_url('teachers/edit/' . esc($teacher['id'])) ?>" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i> Modifier</a>
                                        <a href="<?= site_url('teachers/delete/' . esc($teacher['id'])) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce professeur ?');"><i class="fas fa-trash"></i> Supprimer</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        <?php else: ?>
            ...
            <a href="<?= site_url('teachers/add') ?>" class="btn btn-primary mt-3"><i class="fas fa-plus"></i> Ajouter un professeur</a>
        </div>
    </div>
