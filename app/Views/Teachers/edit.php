...
<body>
    ...
    <div class="main-content">
        ...
        <div class="content-container">
            ...
            <form action="<?= site_url('teachers/update/' . esc($teacher['id'])) ?>" method="post">
                <div class="form-group">
                    <label for="name">Nom</label>
                    <input type="text" name="nom" id="name" class="form-control" value="<?= esc($teacher['nom']) ?>" required>
                </div>
                <div class="form-group">
                    <label for="contact">Contact</label>
                    <input type="text" name="contact" id="contact" class="form-control" value="<?= esc($teacher['contact']) ?>" required>
                </div>
                <div class="form-group">
                    <label for="email">Email</label>
                    <input type="email" name="email" id="email" class="form-control" value="<?= esc($teacher['email']) ?>" required>
                </div>
                <div class="form-group">
                    <label for="intervenant">Intervenant</label>
                    <input type="text" name="intervenant" id="intervenant" class="form-control" value="<?= esc($teacher['intervenant']) ?>" required>
                </div>
                <div class="form-group">
