...
<body>
    ...
    <div class="main-content">
        ...
        <h1 class="mt-5">Liste des salles</h1>
        <table class="table table-striped">
            ...
            <tbody>
            <?php if (!empty($classrooms) && is_array($classrooms)): ?>
                    <?php foreach ($classrooms as $classrooms): ?>
                        <tr>
                            <td><?= esc($classrooms['nom']) ?></td>
                            <td><?= esc($classrooms['type']) ?></td>
                            <td><?= esc($classrooms['capacity']) ?></td>
                            <td>
                                <a href="<?= site_url('classroom/edit/' . esc($classrooms['id'])) ?>" class="btn btn-warning btn-sm">Modifier</a>
                                <a href="<?= site_url('classroom/delete/' . esc($classrooms['id'])) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cette salle ?');">Supprimer</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php else: ?>
                    <tr>
                        <td colspan="6" class="text-center">Aucun salle trouvé.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>

        <a href="<?= site_url('classroom/add') ?>" class="btn btn-primary mt-3">Ajouter un salle</a>
        </div>
