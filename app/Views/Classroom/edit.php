...
<body>
    ...
    <div class="main-content">
        ...
        <h1>Modifier le salle</h1>
        <form action="<?= site_url('classroom/update/' . esc($classrooms['id'])) ?>" method="post">
        <div class="form-group">
                <label for="name">Nom</label>
                <input type="text" name="nom" id="name" class="form-control" value="<?= esc($classrooms['nom']) ?>" required>
            </div> 
            <div class="form-group">
                <label for="name">Types</label>
                <input type="text" name="type" id="type" class="form-control" value="<?= esc($classrooms['type']) ?>" required>
            </div>
            <div class="form-group">
                <label for="name">Capacité</label>
                <input type="text" name="capacity" id="capacity" class="form-control" value="<?= esc($classrooms['capacity']) ?>" required>
            </div>   
            <div class="form-group">
                <button type="submit" class="btn btn-primary">Mettre à jour</button>
                <a href="<?= site_url('classroom') ?>" class="btn btn-danger ">Annuler</a>
            </div>
        </form>
    </div>
    </div>
