...
<body>
    ...
    <div class="main-content">
        ...
        <form action="<?= site_url('schedule/store') ?>" method="post">
        <div class="form-group">
            <label for="event_name">Nom de l'événement:</label><br>
        ...
        <div class="form-group">
            ...
            <input type="time" id="start_time" name="start_time"  step="60" class="form-control">
        </div>
        <div class="form-group">
            <label for="end_time">Heure de fin:</label><br>
            <input type="time" id="end_time" name="end_time"   step="60" class="form-control">
        </div>
        <div class="form-group">
