...
<body>
    ...
    <div class="main-content">
            ...
            <tbody>
                <?php foreach ($schedules as $schedule) : ?>
                    <tr>
                        ...
                        <td>
                                <a href="<?= site_url('schedule/edit/' . esc($schedule['id'])) ?>" class="btn btn-warning btn-sm">Modifier</a>
                                <a href="<?= site_url('schedule/delete/' . esc($schedule['id'])) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cette événement ?');">Supprimer</a>
                            </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        ...
        <div class="form-group">
            <a class="btn btn-primary" href="<?= site_url('schedule/create') ?>">Ajouter un événement</a>
        </div>
    </div>
