...
<body>
    ...
    <div class="main-content">
        ...
        <form action="<?= site_url('schedule/update/' . esc($schedules['id'])) ?>" method="post">
        <div class="form-group">
            <label for="event_name">Nom de l'événement:</label>
            <input type="text" id="event_name" name="event_name" class="form-control"  value="<?= esc($schedules['event_name']) ?>">
        </div> 
        <div class="form-group">
            <label for="date">Date:</label>
            <input type="date" id="date" name="date" class="form-control" value="<?= esc($schedules['date']) ?>">
        </div>
        <div class="form-group">
            <label for="start_time">Heure de début:</label>
            <input type="time" id="start_time" name="start_time"  step="60" class="form-control" value="<?= esc($schedules['start_time']) ?>">
        </div>
        <div class="form-group">
            <label for="end_time">Heure de fin:</label>
            <input type="time" id="end_time" name="end_time"   step="60" class="form-control" value="<?= esc($schedules['end_time']) ?>" >
        </div>
        <div class="form-group">
                <button type="submit" class="btn btn-primary">Mettre à jour</button>
                <a href="<?= site_url('schedule') ?>" class="btn btn-danger ">Annuler</a>
            </div>
