...
<body>
    ...
    <div class="main-content">
        ...
        <div class="content-container">
            ...
            <form action="<?= site_url('students/update/' . esc($student['id'])) ?>" method="post">
                <div class="form-group">
                    <label for="name">Nom</label>
                    <input type="text" name="nom" id="name"  class="form-control" value="<?= esc($student['nom']) ?>" required>
                </div>
                <div class="form-group">
                    <label for="email">Email</label>
                    <input type="email" name="email" id="email"   class="form-control"value="<?= esc($student['email']) ?>" required>
                </div>
            <div class="form-group">
                    <label for="age">Filière</label>
                    <input type="text" name="filiere" id="filiere"  class="form-control" value="<?= esc($student['filiere']) ?>" required>
                </div>
                <div class="form-group">
