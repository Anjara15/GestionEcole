...
<body>
    ...
    <div class="main-content">
        ...
        <div class="content-container">
                    ...
                    <?php if (!empty($students) && is_array($students)): ?>
                        <?php foreach ($students as $student): ?>
                            <tr>
                                ...
                                <td><?= esc($student['filiere']) ?></td>
                               
                                <td>
                                    <a href="<?= site_url('students/edit/' . esc($student['id'])) ?>" class="btn btn-warning btn-sm">Modifier</a>
                                    <a href="<?= site_url('students/delete/' . esc($student['id'])) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cet étudiant ?');">Supprimer</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    <?php else: ?>
            ...
            <a href="<?= site_url('students/add') ?>" class="btn btn-primary mt-3">Ajouter un étudiant</a> 
          </div> 
    </div>
